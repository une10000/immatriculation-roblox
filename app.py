        ...
        if agent_select:
            with st.container(border=True):
                ...
                if not user_data.empty:
                    ...
                    # 2. Calcul des Primes et Bonus (Staff/Averis inclus)
                    primes_detail_list = []
                    calcul_primes = 0
                    ...
                    total_brut = 15000 + calcul_primes # Salaire de base fixe à 15k
                    ...
                    if count_rct >= 3:
                        argent_pour_rct = 200 # Offre Trio
